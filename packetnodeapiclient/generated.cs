...
namespace packetnodeapiclient.xrouter
{
    ...
    public partial class XrouterClient 
    {
        ...
        public XrouterClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MessageListing>> GetMessageListAsync(int? offset = null, int? maxitems = null, string? to = null, string? at = null, string? from = null, string? subject = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v1/mail/msgs"
                    urlBuilder_.Append("api/v1/mail/msgs");
                    urlBuilder_.Append('?');
                    if (offset != null)
                    {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<MessageListing>>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PostResponse> PostMessageAsync(PostMessage body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (body == null)
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Message> GetMessageAsync(int msgNumber, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (msgNumber == null)
                throw new System.ArgumentNullException("msgNumber");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/mail/msgs/{msgNumber}"
                    urlBuilder_.Append("api/v1/mail/msgs/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(msgNumber, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class ListingLinks
    {
    ...
    public partial class Message
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("rcvd")]
        public long Rcvd { get; set; } = default!;
        ...
        public ListingLinks Links { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.4.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class MessageListing
    {
